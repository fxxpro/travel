...
$che=mysqli_query($conn,"select * from food where classify=2");
$foolInfo=mysqli_fetch_all($che,MYSQLI_ASSOC);
?>
<!DOCTYPE HTML>
<html>
            ...
            <div class="banner-box transform-box">
                <div class="met-banner banner-ny-h" data-height=''>
                    ...
                    <div class="slick-slide">
                        ...
                        <img class="cover-image" data-size="1170_100" src="./static/yp/11.jpg" srcset='' sizes="(max-width: 767px) 767px" alt="">
            ...
            <div class="met-product animsition type-1">
                <div class="container">
                    <ul class="blocks-2 blocks-sm-2 blocks-md-3 blocks-xlg-3  met-page-ajax met-grid" id="met-grid" data-scale='0.66666666666667'>
                        <?php foreach ($foolInfo as $k=>$v){?>
                        <li class=" shown">
                            <div class="widget widget-shadow">
                                <figure class="widget-header cover">
                                    <a href="./product.php?type=food&id=<?php echo $v['id'];?>" title="<?php echo $v['name']?>" target="_blank">
                                        <img class="cover-image" src='<?php echo $v['upload'];?>' alt="" style='height:200px;'>
                                    </a>
                                </figure>
                                <h4 class="widget-title">
                                    <a href="./product.php?type=food&id=<?php echo $v['id'];?>"  target="_blank"><?php echo $v['name']?></a>
