<?php
 ...
 if(isset($_POST['submit'])){
     ...
     $che=mysqli_query($conn,"select * from spot where name ='$spot_name' limit 0,1");
     ...
     $time=time();
     $sql="INSERT INTO spot (price,name,address,content,ctime,upload) values ('$price','$spot_name','$address','$content','$time','$filename')";
...
<div class="div_left">
    ...
    <form id="form_demo"  action="./addSPot.php"  enctype="multipart/form-data" method="post" class="form_b">
        <p class="form_p"><label class="form_label">景点名称：</label><input type="text" name="spot_name" class="form_input " minlength="2"  required ><i class="i_start"></i> </p>
        ...
        <p class="form_p"><label class="form_label">地址：</label><input type="text" name="address" class="form_input " minlength="2"  required ><i class="i_start"></i> </p>
