<?php
   include('../../../static/php/conn.php');
    if(isset($_POST['submit'])){
        ...
        $phone=$_POST['phone'];
        $che=mysqli_query($conn,"select * from register where username ='$admin_name'");
        ...
        $time=time();
        $sql="INSERT INTO register (username,phone,password,pwd,ctime,type) values ('$admin_name','$phone','123456','123456','$time','1')";
...
<body>
    ...
    <div class="div_left">
        ...
        <form id="form_demo" method="post" action="./addAdmin.php" enctype="multipart/form-data" class="form_b">
            <p class="form_p"><label class="form_label">管理员名称：</label><input type="text" name="admin_name" class="form_input " minlength="2" required><i class="i_start"></i> </p>
            <p class="form_p"><label class="form_label">管理员手机号：</label><input type="text" name="phone" class="form_input " minlength="2" required><i class="i_start"></i> </p>
