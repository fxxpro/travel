...
$che=mysqli_query($conn,"select * from food where classify=1");
                ...
                <div class="banner-box transform-box">
                    <div class="met-banner banner-ny-h" data-height=''>
                        ...
                        <div class="slick-slide">
                            ...
                            <img class="cover-image" data-size="1170_100" src="./static/yp/9.jpg" srcset='' sizes="(max-width: 767px) 767px" alt="">
                        ...
                        <li class=" shown">
                                <div class="widget widget-shadow">
                                    <figure class="widget-header cover">
                                        <a href="./product.php?type=food&id=<?php echo $v['id'];?>"  target="_blank">
