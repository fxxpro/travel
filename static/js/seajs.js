...
!(function (a, b) {
  ...
  function r() {
    ...
    for (
      var a = Q.getElementsByTagName('script'), b = a.length - 1;
      b >= 0;
      b--
    ) {
      var c = a[b];
  ...
  function s(a) {
    var b = [];
    return (
      a.replace(X, '').replace(W, function (a, c, d) {
        d && b.push(d);
      }),
      b
    );
  ...
  if (!a.seajs) {
    ...
    (t.prototype.resolve = function () {
      ...
      (t.prototype.onload = function () {
        ...
        for (c in b)
          b.hasOwnProperty(c) &&
            ((d = Y[c]), (d._remain -= b[c]), 0 === d._remain && d.onload());
      ...
      (t.prototype.fetch = function (a) {
        ...
        return !h || _[h]
          ...
          : (($[h] = !0),
            ...
            C(
              'request',
              (g = { uri: f, requestUri: h, onRequest: d, charset: v.charset })
            ),
