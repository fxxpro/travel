<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if(!$userInfo){
     ...
     if($res){
         header("refresh:0;url=./product.php?id=$con_id&type=$type");
         exit();
      }
  }
   ...
   <!-- 导航栏 -->
    ...
    <div class="showall">
        ...
        <div class="tb-property">
            ...
            <div class="txt-h">
                <span class="tex-o">地址</span>
				<span class="number ty1"><?php echo $info['address'];?></span>
            </div>
            <div class="txt">
	       ...
	       <table  class="jud_list" style="width:100%; margin-top:30px;border:2px solid #eaeaea;"  cellspacing="0" cellpadding="0">
					<?php foreach($commentInfo as $k=>$v){?>	
		              <tr valign="top" style="border-bottom: 1px solid #eaeaea;">
                            ...
                            <td width="200">
                            <span>
                                评论时间：<?php  echo date('Y-m-d H:i:s',$v['ctime']) ;?></span>
                            </td>
                            <td>
